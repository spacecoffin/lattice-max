...
#include "ext_obex.h"
#include "z_dsp.h"
//#include "m_pd.h"   // standard pd header?
...
{
  t_object x_obj;     // t_object header
  t_float x_f;
  t_latticectl x_ctl;
} t_lattice;
...
static t_class *lattice_class;

// lattice_tilde_setup => ext_main
void ext_main(void *r)    // arg was just "void" without an arg name
{
  //post("lattice~ v0.1");
    t_class = class_new(gensym("lattice~"), (t_newmethod)lattice_new,
